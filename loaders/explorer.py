...
def get_user_details_json(address: str, use_cache: bool = True, filtered: bool = True) -> dict:
    """
    ...
    if os.path.isfile(cache_path) and use_cache:
        ...
        try:
            ...
            raw_cache_path = os.path.join(user_details_dir, f"{address.lower()}_raw.json")
            ...
            if filtered:
                ...
                if "txs" in filtered_data:
                    filtered_data["txs"] = [
                        tx for tx in filtered_data["txs"] 
